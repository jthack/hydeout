...
The ways that AI is used in these systems varies, but here are some ways I can see AI being useful:
...
### Hero: My Hackbot POC
A few months ago, I wrote a little hackbot proof of concept. As inspiration to the readers, I've decided to release it with this blog post. Here's the link:
[https://github.com/jthack/hero](https://github.com/jthack/hero)

The name `hero` is from Snowcrash, where the main character's name is Hero. 

It takes a raw http request as input, and gives AI the ability to suggest potential vulnerabilities, write the payload, as well as execute and validate the payloads.
...
- To OpenAI and other foundation model makers: Please don't nerf security expertise in your models. GPT4 is already denying me a good amount when using it for hacking. It's not going to prevent this type of product. The builders will just move to solely open-source.
...
[Sign up for my email list](https://thacker.beehiiv.com/subscribe) to know when I post more content like this. I also [post my thoughts on Twitter/X](https://x.com/rez0__). 
